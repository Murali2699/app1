...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        if($schemecate =='' && $schemecode =='' && $schemename =='' && $subschemename =='' && $idepartment ==0 && $isubdepartment ==0){
            ...
            $sqlQuery = "select * from fn_payment_summary_getmaindashboarddetails('".$schemecate."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id);";

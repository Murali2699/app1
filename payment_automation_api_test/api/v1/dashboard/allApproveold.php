    ...
    /*form filter datas*/
        ...
        $action ='';
            ...
            // echo json_encode($data);
                ...
                $stmt = $write_db->prepare("CALL sp_payment_approvebulk(:updatestatus, :approvalstatus, :approvedy, :benificiaryid, :schemeid, :schemename, :subschemename, :idepartment,:isubdepartment,:districtcode,:talukcode,:jurisdictionlayercode,:iyearcode,:fromdate,:todate,:paymentperiod,:trackingid)");

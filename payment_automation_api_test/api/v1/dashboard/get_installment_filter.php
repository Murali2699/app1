...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $user_id = isset($_POST['user_id']) ? $_POST['user_id'] : 0;
        ...
        // if(($schemecate !='' && $schemecode =='' && $schemename =='' && $subschemename =='' && $idepartment ==0 && $isubdepartment ==0)||($schemecate =='' && $schemecode =='' && $schemename =='' && $subschemename =='' && $idepartment ==0 && $isubdepartment ==0)){
        //     // echo '3';
        ...
        $sqlQuery = "select * from fn_scheme_getpaymentinstallmentsbyschemeandperiod($schemeID,$paymentcycle,$paymentperiod,$user_id);";
       	$sqlQuery;
        $action ='';

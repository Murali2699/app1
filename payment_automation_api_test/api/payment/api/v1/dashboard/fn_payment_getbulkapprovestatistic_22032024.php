...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if ($schemeID!=0 && isset($taluk_code) && isset($shop_code)) {
        ...
        $sqlQuery = "select * from fn_payment_getbulkapprovestatistic($benificiaryid,$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$iyyyymm."','".$fromdate."','".$todate."',$paymentperiod) $qry;";    
        // echo $sqlQuery;exit;

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        if ($schemeIDprepost_count >= 1) {
            ...
            // if ($schemeID!=0) {
            //  echo "CALL sp_payment_approvebulk(false,".$approvalstatus.",$approvedy,".$benificiaryid.", ".$schemeID.",'".$schemename."','".$subschemename."',".$idepartment.",".$isubdepartment.",".$summaryDistrictCode.",".$summaryTalukCode.",'".$jurisdictionlayercode."','".$iyearcode."','".$fromdate."','".$todate."',".$paymentperiod.",".$trackingId.")";exit;
            // print_r($_POST);exit;
        $action ='';
        ...
        // print_r($_POST);exit;
            ...
            // echo json_encode($data);
                ...
                if($result){
                    $data = array(
                    "success" => 1, 
                    "message" => "Payment Bulk Approve Successfully", 
                    'data' => $result
                    );
                }else{
                    $data = array(
                        "success" => 0, 
                        "message" => "Payment Pending Not Bulk Approve Successfully",
                        'data' => null
                    );
                }

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        if ($schemeIDprepost_count >= 1) {
            ...
            // if ($schemeID!=0) {
            //  echo "CALL sp_payment_approvebulk(false,".$approvalstatus.",$approvedy,".$benificiaryid.", ".$schemeID.",'".$schemename."','".$subschemename."',".$idepartment.",".$isubdepartment.",".$summaryDistrictCode.",".$summaryTalukCode.",'".$jurisdictionlayercode."','".$iyyyymm."','".$fromdate."','".$todate."',".$paymentperiod.",".$trackingId.")";exit;
            // print_r($_POST);exit;
        $action ='';

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($columnIndex!=0){
        ...
        $sqlQuery = "select * from fn_payment_report_getpaymentfilestatus('".$schemecategory."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id) $qry;";

        // echo $sqlQuery;exit;

        // $totalCountsqlQuery = "select count(*) from fn_payment_report_getpaymentfilestatus('".$schemecategory."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id) $qry;";

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        $reasonCode = isset($_POST['reason_code']) ? $_POST['reason_code']:'';
    ...
    // if ($schemeID!=0 && isset($taluk_code) && isset($shop_code)) {
        ...
        $sqlQuery = "select *, (apb_benificiaries_count + ach_benificiaries_count) as total_count,(apb_benificiaries_amount + ach_benificiaries_amount) as total_value from fn_payment_getbulkreinitiatestatistic($benificiaryid,$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$iyearcode."','".$fromdate."','".$todate."',$paymentperiod,'$reasonCode') $qry;";    
        // echo $sqlQuery;exit;
        ...
        if ($prepost_count >= 1) {
            ...
            foreach ($bulkApproveSummary as $key => $values) {
                ...
                $bulkApproveSummaryAddTracking[$key]['status'] = 0;
            }

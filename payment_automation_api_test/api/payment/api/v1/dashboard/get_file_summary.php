...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $qry="";
    if($searchValue!=""){
        $qry="where lower(reason_code) like '%$searchValue%'
        OR lower(reason) like '%$searchValue%'";
    }
    ...
    if($columnIndex!=0){
        ...
        $sqlQuery = "select * from fn_payment_report_getfiletransfersummary('".$schemecategory."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id) $qry ";

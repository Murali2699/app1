...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        $paymentdate = !empty($filters['payment_date_input']) ? $filters['payment_date_input']:"2000-01-01";
    ...
    if($columnIndex!=0){
        ...
        $sqlQuery = "select * from fn_payment_report_getfailurereasonwisesummary('".$schemecategory."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id) $qry;";

        // echo $sqlQuery;exit;

        $totalCountsqlQuery = "select count(*) from fn_payment_report_getfailurereasonwisesummary('".$schemecategory."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id) $qry;";

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlQuery ="select * from fn_validation_getvalidationsummary($schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$iyyyymm."','".$fromdate."','".$todate."',$paymentperiod,'".$user_id."') $qry;";

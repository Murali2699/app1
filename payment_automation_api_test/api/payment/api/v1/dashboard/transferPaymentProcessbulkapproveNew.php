...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        $yearcode = !empty($filters['ddl_year']) ? $filters['ddl_year']:'';
     ...
     // $stmt = $write_db->prepare("CALL sp_payment_onboardbeificiaries(false,$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$yyyymm."','".$fromdate."','".$todate."',$paymentperiod,'".$user_id."',$trackingid,$updatedby)");
    ...
    $stmt = $write_db->prepare("CALL sp_payment_onboardbeificiaries(:updatestatus,:ischemeid,:ischemename,:isubschemename,:idepartment,:isubdepartment,:idistrictcode,:italukcode,:ijurisdictionlayercode,:iyearcode,:ifromdate,:itodate,:ipaymentperiod,:iuserid,:trackingid, :updatedby)");
        ...
        $stmt->bindParam(':iyearcode', $yearcode, PDO::PARAM_STR);

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $upload_reference_no_int= intval($upload_reference_no);
        $getBeneficiaryUploadStatusSqlQuery = "SELECT COUNT(*) FROM dump_payment_details_temp WHERE upload_reference_no = $upload_reference_no_int";
    
        $query_stmt = $read_db->prepare($getBeneficiaryUploadStatusSqlQuery);
        $query_stmt->execute();

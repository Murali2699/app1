...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        $row = 0;
        $rowperpage = isset($_POST['tableRecordCount']) ? $_POST['tableRecordCount']:0;
    ...
    $qry="";
        $sqlQuery = "select * from fn_payment_getbenificiariesforapproval($benificiaryid,$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$yyyymm."','".$fromdate."','".$todate."',$paymentperiod,$approvalstatus,$rowperpage,$row) $qry;";
        ...
        if ($prepost_count >= 1) {
            $payment_process = $queryStmt->fetchAll(PDO::FETCH_ASSOC);

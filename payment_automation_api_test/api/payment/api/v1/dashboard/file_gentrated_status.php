...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        $sqlQuery = "select * from fn_payment_report_getfilegenerationsummary('".$schemecategory."',$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,$installmentid,$yearmonth,'".$paymentdate."',$user_id)";

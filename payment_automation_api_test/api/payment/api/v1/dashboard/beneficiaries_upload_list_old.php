...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    /*form filter datas*/
        ...
        $filters = json_decode($_POST['fileters'])[0]->schemes_filters;
        ...
        $uploadreferenceno = isset(json_decode($_POST['fileters'])[0]->upload_reference_no) ? json_decode($_POST['fileters'])[0]->upload_reference_no:0;

...
try {
    ...
    $stmt = $read_db->query("SELECT * FROM fn_payment_getbankiindetails();");
    ...
    $writer->save('/opt/lampp/htdocs/payment_automation/api/payment/api/v1/Export_Bank_IIN_Details.xlsx');

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if ($schemeID!=0 && isset($taluk_code) && isset($shop_code)) {
        ...
        $sqlQuery = "select *,(apb_benificiaries_count + ach_benificiaries_count) as total_count,(apb_benificiaries_amount + ach_benificiaries_amount) as total_value from fn_payment_getbulkreinitiatestatistic($benificiaryid,$schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$iyearcode."','".$fromdate."','".$todate."',$paymentperiod,'$reason_code') $qry;";    
        // echo $sqlQuery;exit;

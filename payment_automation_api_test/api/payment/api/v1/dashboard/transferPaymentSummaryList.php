...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if ($schemeID!=0 && isset($taluk_code) && isset($shop_code)) {
        ...
        $sqlQuery = "select district_name,taluk_name,apb_count,apb_amount,ach_count,ach_amount,total_count,total_amount,distirict_code,taluk_code from  fn_validation_getpretransfersummary($schemeID,'".$schemename."','".$subschemename."',$idepartment,$isubdepartment,$districtcode,$talukcode,'".$jurisdictionlayercode."','".$iyearcode."','".$fromdate."','".$todate."',$paymentperiod,'".$user_id."') $qry;";
